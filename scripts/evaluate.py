...
def argument_parser():
    ...
    parser.add_argument(
        "--model", type=str, required=True, help="The model to evaluate."
    )
    parser.add_argument(
        "--dataset", type=str, required=True, help="The dataset to evaluate on."
    )
...
class ModelEval:
    def __init__(self, model, tokenizer, dataset):
        ...
        self.accelerator = accelerate.Accelerator(
            device_placement=True, mixed_precision="bf16"
        )
